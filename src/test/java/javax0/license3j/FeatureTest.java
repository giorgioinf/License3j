...
public class FeatureTest {
    ...
    public void testDateFromString() {
        ...
        final Date now1 = Date.from(LocalDateTime.of(
                2018,12, 17,
        ...
        final Date now2 = Date.from(LocalDateTime.of(
                2018,12, 17,
                12,55,19)
                .toInstant(ZoneOffset.UTC));
        ...
        final Date now3 = Date.from(LocalDateTime.of(
                2018,12, 17,
                12,55)
                .toInstant(ZoneOffset.UTC));
    ...
    public void testDateToString() {
        final Date now = Date.from(LocalDateTime.of(
                2018,12, 17,
                12,55,19,295 * 1000000)
                .toInstant(ZoneOffset.UTC));
        final Feature sut = Feature.Create.dateFeature("now", now);
